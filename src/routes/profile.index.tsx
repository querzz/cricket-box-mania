...
function ProfileScreen() {
  ...
  return (
    ...
    >
      ...
      <GlassCard className="mt-5 flex items-center gap-3 px-4 py-4">
        ...
        <Link
          ...
          className="press grid size-11 shrink-0 place-items-center rounded-full [background-image:var(--gradient-primary)] shadow-[var(--shadow-glow)]"
        >
