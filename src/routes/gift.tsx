  ...
  return (
    <AppShell title="Your gift" back="/" nav={false}>
      <div className="relative mt-6 grid place-items-center">
        ...
        <div aria-hidden className="absolute size-56 rounded-full bg-primary/30 blur-3xl animate-glow-pulse" />
        <img
          src={assets.gift}
          alt="Daily gift box"
          width={1024}
          height={1024}
          className={cn(
            "relative size-60 object-contain drop-shadow-[0_20px_40px_oklch(0.05_0.02_340_/_75%)]",
      ...
      <div className="mt-7 space-y-3">
        <PrimaryButton fullWidth loading={busy} disabled={!available} onClick={() => void open()}>
